-- Apply dispute analytics migration to local database
-- Run with: PGPASSWORD=postgres psql -h 127.0.0.1 -p 54322 -U postgres -d postgres -f apply-dispute-analytics-migration.sql

\echo 'Creating get_dispute_analytics function...'
...
\echo 'Migration complete! Function get_dispute_analytics created successfully.'
